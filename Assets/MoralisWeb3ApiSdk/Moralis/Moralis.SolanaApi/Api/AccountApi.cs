...
namespace Moralis.SolanaApi.Api
{
    public class AccountApi : IAccountApi
	{
		...
		public async Task<SplTokenBalanace> GetSplTokens(NetworkTypes network, string address)
		{
			// Verify the required parameter 'pairAddress' is set
			...
			return (SplTokenBalanace)ApiClient.Deserialize(response.Content, typeof(SplTokenBalanace), response.Headers);
		}

		public async Task<SplNft> GetNFTs(NetworkTypes network, string address)
        {
			// Verify the required parameter 'pairAddress' is set
			...
			return (SplNft)ApiClient.Deserialize(response.Content, typeof(SplNft), response.Headers);
		}
